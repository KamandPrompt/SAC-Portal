...
mycursor.execute("CREATE TABLE Events(eventID Integer(6) AUTO_INCREMENT PRIMARY KEY, eventName varchar(30), about varchar(600), eventDate date, eventTime time, eventVenue varchar(30), clubID char(6), registered varchar(3000), attended varchar(3000), FOREIGN KEY (clubID) REFERENCES Clubs(clubID));")
